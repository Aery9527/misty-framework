...
public class MistyApiConstant {
	...
	public static final String PREFIX = "org.misty.fw.api";

	/* [static] */

	public static class SystemEnvironmentKeys {
		private static final String PREFIX = MistyApiConstant.PREFIX + ".se";
	}
